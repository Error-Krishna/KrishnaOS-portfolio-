...
export function Wallpaper({ className, variant = 'shell' }: WallpaperProps) {
  ...
  const overlayOpacity = variant === 'boot' ? 0.42 : variant === 'recruiter' ? 0.22 : 0.18;
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `linear-gradient(180deg, rgb(10 10 12 / ${overlayOpacity}), rgb(10 10 12 / ${overlayOpacity + 0.08})), url(${WALLPAPERS[resolvedTheme]})`,
